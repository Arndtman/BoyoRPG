    ...
    while True:
        ...
        for item in read_lines:
            ...
            if "*" in item:
                ...
                #a = lambda x: int(filter(str.isdigit, x) or 0)
                if "CLICK" in item:
                    print (item)
                    clickBool = True
                else:
                    ...
                    if stopBool:
                        ...
                        playChar.x_vel = x_vel_A
                        playChar.y_vel = y_vel_A
