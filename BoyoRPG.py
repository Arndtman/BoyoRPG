...
##               or footRect.colliderect(w10) or footRect.colliderect(w11):
        ...
        pygame.draw.rect(gameDisplay, blue, (0,0, 180, 270))
        pygame.draw.rect(gameDisplay, blue, (0, 200, 25, 600))
        pygame.draw.rect(gameDisplay, blue, (25, 350, 155, 170))
        pygame.draw.rect(gameDisplay, blue, (0, 570, 800, 30))
        pygame.draw.rect(gameDisplay, blue, (600, 435, 80, 110))
        pygame.draw.rect(gameDisplay, blue, (755, 0, 45, 600))
        pygame.draw.rect(gameDisplay, blue, (565, 35, 190, 65))
        pygame.draw.rect(gameDisplay, blue, (180, 30, 305, 70))
        pygame.draw.rect(gameDisplay, blue, (180, 95, 115, 30))
        pygame.draw.rect(gameDisplay, blue, (410, 100, 75, 30))
        pygame.draw.rect(gameDisplay, blue, (295, 240, 460, 195))
        pygame.draw.rect(gameDisplay, blue, (490, 5, 565, 210))
