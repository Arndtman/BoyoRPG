...
##    ball1 = BossTest.FireBall(B1.x - 20, B1.y - 20)
##    ball2 = BossTest.FireBall(B1.x - 20, B1.y + B1.h)
##    mylist = []
##    for i in range(5):
##        mylist.append(BossTest.Rocks())
    while True:
        for event in pygame.event.get(): 
...
##                playChar.swingBoundary(B1)
##                playChar.swingBoundary(ball1)
##                playChar.swingBoundary(ball2)
##                print(B1.health) 
                attack = True
...
##            B1.displayMob()
##            B1.seek()
##            B1.charCollision(playChar)
##            for item in mylist:
##                item.fall(playChar) 
##            if ball1.isAlive(): 
##                ball1.displayMob(playChar)
##            elif random.randint(0, 100) < 5:
##                ball1.respawn(B1)
##            if ball2.isAlive():
##                ball2.displayMob(playChar)
##            elif random.randint(0, 100) < 5:
##               ball2.respawn(B1)
